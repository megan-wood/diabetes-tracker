...
import GlucoseEditForm from "@/components/glucose-edit-form";
...
export default function EditOptions({selectedEntry}: any) {
  ...
  return (
    <>
      <DropdownMenu>
          ...
          <DropdownMenuContent align="start">
              ...
              <DropdownMenuItem onSelect={() => setShowEditDialog(true)}>
                  <Pencil/>Edit
                  {/* <GlucoseEditForm entry={selectedEntry}/> */}
              </DropdownMenuItem>
              <DropdownMenuItem onSelect={(e) => {
                e.preventDefault(); // stop dropdown from closing first
      ...
      <GlucoseEditForm entry={selectedEntry} open={showedEditDialog} setOpen={setShowEditDialog} />
    </>
  )
}