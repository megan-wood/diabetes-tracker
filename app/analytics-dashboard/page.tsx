...
export default function AnalyticsDashboard() {
  ...
  return (
    ...
    <div className="flex flex-col w-full m-5 space-y-2">
      ...
      <h2>One month fasting average: {calculateFastingAvg(1)}</h2>
      <h2>Two month fasting average: {calculateFastingAvg(2)}</h2>
      <h2>Three month fasting average: {calculateFastingAvg(3)}</h2>
